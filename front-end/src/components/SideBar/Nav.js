  ...
  render() {
    ...
    return (
      <ul className="nav">
        ...
        <li className={this.isPathActive('/problems') || this.state.problemMenuOpen ? 'active' : null}>
          <a onClick={() => this.setState({ problemMenuOpen: !this.state.problemMenuOpen })} data-toggle="collapse">
            <i className="pe-7s-note2"></i>
            <p>Problemas <b className="caret"></b></p>
          </a>
          <Collapse in={this.state.problemMenuOpen}>
            <div>
              <ul className="nav">
                <li className={this.isPathActive('/problems/add-problem') ? 'active' : null}>
                  <Link to="/problems/add-problem">Añadir Problema</Link>
                </li>
                <li className={this.isPathActive('/problems/problem-table') ? 'active' : null}>
                  <Link to="/problems/problem-table">Problemas</Link>
                </li>
              </ul>
            </div>
          </Collapse>
